...
public class Util
{
    ...
    public static Map<String, String> readDBpedia() {
        String typesFile = "wiki-data/dbpedia_types_en.nt1.gz";
        if (dbpedia != null)
            return dbpedia;
        dbpedia = new LinkedHashMap<String, String>();
        int d = 0, numPersons = 0, lines = 0;
        try {
            LineNumberReader lnr = new LineNumberReader(new InputStreamReader(new GZIPInputStream(new FileInputStream(typesFile)), "UTF-8"));
            while (true)
            {
                ...
                if (line == null)
                    break;
                if (lines++ % 500000 == 0)
                    System.out.println ("Processed " + lines + " lines of approx. 2.35M in " + typesFile);
        ...
        System.out.println("Read " + dbpedia.size() + " names from DBpedia, " + numPersons + " people name. dropped: " + d);
        System.out.println("Read " + dbpedia.size() + " names from DBpedia, " + numPersons + " people name. dropped: " + d);
    ...
    public static String stripPunctuation(String s)
    {
        ...
        // start is our starting indexTitlesWithRedirects for non-punct
